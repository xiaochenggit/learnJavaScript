window.onload = function(){
	imgDolig.init({
		...
		Width:  800,
		Height : 450,
		href : "http://www.duoqu.com/game/play/index/g/57/s/*",
		time: 10000,
		closeRight : "38px",
		hrefLeft : "281px",
		hrefBottom : "38px"
...
var imgDolig = {
	...
	show : function (){
		...
		arr.push("</embed>");
		arr.push("</object>");
		arr.push("<p id='imgDoligclose'style='position:absolute;width:50px;height:50px;right:"+this.closeRight+";top:0;cursor:pointer;background-color:#ccc;filter(alpha(opacity=00));opacity:0;' onclick='imgDolig.hide();return false'></p>");
		arr.push("<a href="+this.href+" target='_blank' id='imgDolighref'style='background-color:#ccc;filter(alpha(opacity=00));opacity:0;position:absolute;width:200px;height:73px;bottom:"+this.hrefBottom+";left:"+this.hrefLeft+";' ></a>");
		arr.push("</div>");
